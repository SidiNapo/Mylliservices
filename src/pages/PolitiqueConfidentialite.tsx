          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
            ...
            <div className="border-b border-mylli-light pb-6">
              ...
              <p className="text-mylli-gray leading-relaxed">
                Chez <strong className="text-mylli-primary">Mylli Assistance</strong>, nous nous engageons à protéger 
            ...
            <div className="bg-gradient-to-br from-mylli-primary/5 to-mylli-secondary/5 p-6 rounded-xl">
              ...
              <div className="space-y-3 text-mylli-gray">
                ...
                <div className="space-y-2">
                  <p><strong>Email :</strong> <a href="mailto:contact@mylli-assistance.fr" className="text-mylli-primary hover:text-mylli-secondary">contact@mylli-assistance.fr</a></p>
                  <p><strong>Téléphone :</strong> <a href="tel:+33123456789" className="text-mylli-primary hover:text-mylli-secondary">01 23 45 67 89</a></p>
                  <p><strong>Adresse :</strong> 123 Rue des Soins, 75000 Paris</p>
                </div>
              </div>
            </div>

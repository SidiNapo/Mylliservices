...
const ServiceLocations: React.FC<ServiceLocationsProps> = ({
  ...
  return <ParallaxSection backgroundGradient="linear-gradient(135deg, #f5f9ff 0%, #e1f0fc 100%)" height="auto" pattern="dots" mapLayout={true} glassEffect={true} className={`py-16 ${className}`} overlayOpacity={0.02} overlayColor="#ffffff">
      <div className="container mx-auto px-4">
        <SectionHeading title={title} subtitle={subtitle} variant="gradient" highlightColor="mylli-primary" />
        ...
        <div className="relative mt-12 max-w-6xl mx-auto">
          ...
          <div className="absolute inset-0 -z-10">
            ...
            <div className="absolute top-1/2 left-1/2 w-40 h-40 rounded-full border border-mylli-quaternary/10 animate-spin-slow" style={{
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 order-2 lg:order-1 space-y-4">
              ...
              {locations.map((location, index) => <div key={index} className="p-5 rounded-xl bg-white/80 border-gray-100 shadow-soft border transition-all duration-300 hover:shadow-md hover:border-mylli-primary/20 hover:-translate-y-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                        <div className="bg-gradient-to-br from-mylli-light to-white p-6 rounded-xl border border-mylli-primary/10 hover:shadow-md transition-shadow">
                          ...
                          <p className="text-mylli-gray">Nos services sont disponibles dans Plusieurs villes du Maroc.</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-mylli-light to-white p-6 rounded-xl border border-mylli-primary/10 hover:shadow-md transition-shadow">
                          ...
                          <p className="text-mylli-gray">Des soins adaptés à vos besoins spécifiques, tout en restant dans votre domicile.</p>
                        </div>
                      </div>
                    </div>

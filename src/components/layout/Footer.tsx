    ...
    <footer className="bg-gray-50 pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className={`flex items-center ${isRTL ? 'space-x-reverse' : ''} space-x-2 mb-4`}>
              <img src="/lovable-uploads/c2fc9be5-1f88-4ea6-b024-37652a5a671e.png" alt="Mylli Services Logo" className="w-10 h-10" />
              <BrandName />
            </Link>
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-mylli-gray text-sm">&copy; {currentYear} <BrandName size="xs" className="inline" />. {t('footer.rights')}</p>
